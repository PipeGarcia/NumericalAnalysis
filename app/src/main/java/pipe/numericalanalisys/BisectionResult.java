...
public class BisectionResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bisection_result);
        ...
        listViewN = (ListView)findViewById(R.id.listView);
        listViewA = (ListView)findViewById(R.id.listView2);
        listViewFA = (ListView)findViewById(R.id.listView3);
        listViewB = (ListView)findViewById(R.id.listView4);
        listViewX = (ListView)findViewById(R.id.listView6);
        listViewFX = (ListView)findViewById(R.id.listView5);
        listViewError = (ListView)findViewById(R.id.listView7);
